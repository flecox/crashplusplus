...
ENFERMEDAD_PSIQUIATRICA_CHOICE = [(0, u'No hay problema'),
    (1, u'Condición psiquiátrica menor: tratamiento aambulatorio en crisis/ tartamiento ambulatorio por depresión en los últimos 10 años/ uso ocasional de tranquilizantes menores/ demencia leve temprana (MMT >25<28)'),
    (2, u'Historia de depresión mayor en los últimos 10 años/ demencia leve ( MMT 20-25)/ cualquier hospitalización psiquiátrica previa/ cualquier episodio psicótico previo o historia de abuso de sustancias en los últimos 10 años'),
    (3, u'Criterios actuales para depresión mayor o 2 ó mas episodios de depresión mayor en los últimos 10 años/ demencia moderada ( MMT 15-20)/ uso actual de ansiolíticos diarios/ cumple criterios actuaales para abuso o dependencia de sustancias/ requiere antipsicóticos diarios'),
    (4, u'Enfermedad mental actual que requiere hospitalización psiquiátrica, institucionalización o manejo ambulatorio intensivo/ demencia severa ( MMT <15)'),
]
